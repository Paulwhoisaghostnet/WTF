...
const APPEARANCE_RULES: Record<DesktopAppearanceStyleKey, AppearanceRuleSet> = {
  "classic-95": {
    ...
    vars: {
      "--wtf-shell-font": `"MS Sans Serif", "Segoe UI", Tahoma, sans-serif`,
      "--wtf-shell-font-size": "13px",
  ...
  "wtf-xp": {
    react95Theme: water,
    vars: {
      "--wtf-shell-font": `"Trebuchet MS", "Segoe UI", Tahoma, sans-serif`,
      "--wtf-shell-font-size": "13px",
  ...
  "wtf-aqua": {
    react95Theme: white,
    vars: {
      "--wtf-shell-font": `"Lucida Grande", "Segoe UI", Tahoma, sans-serif`,
      "--wtf-shell-font-size": "13px",
  ...
  "wtf-zine": {
    react95Theme: toner,
    vars: {
      "--wtf-shell-font": `"Arial Black", Impact, "Segoe UI", sans-serif`,
      "--wtf-shell-font-size": "13px",
