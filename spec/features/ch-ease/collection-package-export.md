# CH-EASE: Collection package export

## Purpose

Collection package export lets Pasta Protocol users move the CH-EASE workflow toward a valid package outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for collection package export.
...
- Validated state for collection package export.
...
- Standalone validation: open CH-EASE, exercise collection package export, assert visible status and no console-modal dependency.
