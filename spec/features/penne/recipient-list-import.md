# Penne: Recipient list import

## Purpose

Recipient list import lets Pasta Protocol users move the Penne workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for recipient list import.
...
- Validated state for recipient list import.
...
- Standalone validation: open Penne, exercise recipient list import, assert visible status and no console-modal dependency.
