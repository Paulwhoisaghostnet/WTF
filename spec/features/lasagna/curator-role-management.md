# Lasagna: Curator role management

## Purpose

Curator role management lets Pasta Protocol users move the Lasagna workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for curator role management.
...
- Validated state for curator role management.
...
- Standalone validation: open Lasagna, exercise curator role management, assert visible status and no console-modal dependency.
