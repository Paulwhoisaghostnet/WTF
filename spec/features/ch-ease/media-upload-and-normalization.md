...
Media upload and normalization lets Pasta Protocol users move the CH-EASE workflow toward a valid package outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for media upload and normalization.
...
- Validated state for media upload and normalization.
...
- Standalone validation: open CH-EASE, exercise media upload and normalization, assert visible status and no console-modal dependency.
