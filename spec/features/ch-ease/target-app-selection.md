# CH-EASE: Target app selection

## Purpose

Target app selection lets Pasta Protocol users move the CH-EASE workflow toward a valid package outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for target app selection.
...
- Validated state for target app selection.
...
- Standalone validation: open CH-EASE, exercise target app selection, assert visible status and no console-modal dependency.
