# Penne: Airdrop push distribution

## Purpose

Airdrop push distribution lets Pasta Protocol users move the Penne workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for airdrop push distribution.
...
- Validated state for airdrop push distribution.
...
- Standalone validation: open Penne, exercise airdrop push distribution, assert visible status and no console-modal dependency.
