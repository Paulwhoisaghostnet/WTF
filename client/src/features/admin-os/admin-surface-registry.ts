...
export const ADMIN_SURFACES: AdminSurface[] = [
  ...
  },
  {
    ...
    nativeSettings: [
      ...
      "delivery failures",
      "unread badge and read-state sync",
      "message flags, stars, bookmarks, and reactions",
  ...
  },
  {
    ...
    behaviorAssertionIds: ["wtf-live.wim-attendance-identity", "wim.modular-window-roster-tabs"],
  },
  {
    id: "browser",
    label: "Browser",
