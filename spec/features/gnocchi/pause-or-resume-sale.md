# Gnocchi: Pause or resume sale

## Purpose

Pause or resume sale lets Pasta Protocol users move the Gnocchi workflow toward a valid token product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for pause or resume sale.
...
- Validated state for pause or resume sale.
...
- Standalone validation: open Gnocchi, exercise pause or resume sale, assert visible status and no console-modal dependency.
