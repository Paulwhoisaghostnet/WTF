# Spaghetti: Collection metadata and relationship setup

## Purpose

Collection metadata and relationship setup lets Pasta Protocol users move the Spaghetti workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for collection metadata and relationship setup.
...
- Validated state for collection metadata and relationship setup.
...
- Standalone validation: open Spaghetti, exercise collection metadata and relationship setup, assert visible status and no console-modal dependency.
