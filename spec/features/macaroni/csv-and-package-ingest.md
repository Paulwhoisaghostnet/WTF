# Macaroni: CSV and package ingest

## Purpose

CSV and package ingest lets Pasta Protocol users move the Macaroni workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for csv and package ingest.
...
- Validated state for csv and package ingest.
...
- Standalone validation: open Macaroni, exercise csv and package ingest, assert visible status and no console-modal dependency.
