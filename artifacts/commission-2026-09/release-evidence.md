...
| J-08 Calendar participation | PASS — REAL DB LOCAL CANDIDATE | Contestant + operator/local production server + PostgreSQL | reminder/presentation policy 8/8; TTC feed 5/5; focused browser 1/1; focused live actor 1/1; full interaction suite 691/691 | Going survives fresh account read; reminder-enabled filter follows explicit choice; reminder-off and clear persist; update/clear SystemEvents retained | Playwright trace retained only on failure | Production deploy verification pending |
