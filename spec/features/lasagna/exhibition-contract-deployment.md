# Lasagna: Exhibition contract deployment

## Purpose

Exhibition contract deployment lets Pasta Protocol users move the Lasagna workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for exhibition contract deployment.
...
- Validated state for exhibition contract deployment.
...
- Standalone validation: open Lasagna, exercise exhibition contract deployment, assert visible status and no console-modal dependency.
