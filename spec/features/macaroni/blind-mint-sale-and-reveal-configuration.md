# Macaroni: Blind-mint sale and reveal configuration

## Purpose

Blind-mint sale and reveal configuration lets Pasta Protocol users move the Macaroni workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for blind-mint sale and reveal configuration.
...
- Validated state for blind-mint sale and reveal configuration.
...
- Standalone validation: open Macaroni, exercise blind-mint sale and reveal configuration, assert visible status and no console-modal dependency.
