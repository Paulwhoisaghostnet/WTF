...
9. Extend the Macaroni Shadownet puppet lane and the new Spaghetti Shadownet preflight into executable signer-backed deploy/mint/collect, WTF.ME, WTFOS pinning, and Colander discovery tests.
