# Lasagna: Revision manifest validation

## Purpose

Revision manifest validation lets Pasta Protocol users move the Lasagna workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for revision manifest validation.
...
- Validated state for revision manifest validation.
...
- Standalone validation: open Lasagna, exercise revision manifest validation, assert visible status and no console-modal dependency.
