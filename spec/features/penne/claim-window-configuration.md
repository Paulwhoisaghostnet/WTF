# Penne: Claim window configuration

## Purpose

Claim window configuration lets Pasta Protocol users move the Penne workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for claim window configuration.
...
- Validated state for claim window configuration.
...
- Standalone validation: open Penne, exercise claim window configuration, assert visible status and no console-modal dependency.
