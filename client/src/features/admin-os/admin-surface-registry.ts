...
export const ADMIN_SURFACES: AdminSurface[] = [
  ...
  },
  {
    ...
    behaviorAssertionIds: ["skywire.market-feed-search-source", "skywire.oauth-popup-permission-sync"],
  },
  {
    id: "wtf-live",
    label: "WTF LIVE",
  ...
  },
  {
    ...
    kind: "app",
    routePatterns: ["/wim", "/aim"],
    desktopAppKey: "wim",
    adminPanelTabs: ["Users", "System Logs", "Automation"],
    nativeSettings: ["DM-backed buddy list", "presence surface", "notification templates"],
    automationHandles: ["wim.chat.opened", "wim.message.sent", "dm.message.sent", "app.interaction.tracked"],
  },
  {
    id: "browser",
    label: "Browser",
