# Gnocchi: Collector open mint

## Purpose

Collector open mint lets Pasta Protocol users move the Gnocchi workflow toward a valid token product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for collector open mint.
...
- Validated state for collector open mint.
...
- Standalone validation: open Gnocchi, exercise collector open mint, assert visible status and no console-modal dependency.
