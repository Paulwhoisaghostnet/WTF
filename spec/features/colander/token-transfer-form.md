# Colander: Token transfer form

## Purpose

Token transfer form lets Pasta Protocol users move the Colander workflow toward a valid management outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for token transfer form.
...
- Validated state for token transfer form.
...
- Standalone validation: open Colander, exercise token transfer form, assert visible status and no console-modal dependency.
