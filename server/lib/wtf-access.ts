...
export const WTF_STANDARD_BROWSER_ROUTES: WtfBrowserAccessRoute[] = [
  ...
  { path: "/tools/spaghetti", title: "Spaghetti", access: "role-gated-session", purpose: "Pasta Protocol standard collection publisher for Tezos FA2 contracts." },
  { path: "/tools/gnocchi", title: "Gnocchi", access: "role-gated-session", purpose: "Pasta Protocol open-edition publisher for timed and supply-limited editions." },
  { path: "/tools/ravioli", title: "Ravioli", access: "role-gated-session", purpose: "Pasta Protocol bundle publisher for art packs, redeemables, and wrapped sets." },
  { path: "/tools/rotini", title: "Rotini", access: "role-gated-session", purpose: "Pasta Protocol generative collection publisher." },
  { path: "/tools/penne", title: "Penne", access: "role-gated-session", purpose: "Pasta Protocol distribution publisher." },
  { path: "/tools/lasagna", title: "Lasagna", access: "role-gated-session", purpose: "Pasta Protocol curation and exhibition publisher." },
  { path: "/tools/colander", title: "Colander", access: "role-gated-session", purpose: "Pasta Protocol ownership and package management console." },
