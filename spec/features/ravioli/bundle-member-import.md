# Ravioli: Bundle member import

## Purpose

Bundle member import lets Pasta Protocol users move the Ravioli workflow toward a valid token product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for bundle member import.
...
- Validated state for bundle member import.
...
- Standalone validation: open Ravioli, exercise bundle member import, assert visible status and no console-modal dependency.
