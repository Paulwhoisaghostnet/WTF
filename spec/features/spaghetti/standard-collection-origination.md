# Spaghetti: Standard collection origination

## Purpose

Standard collection origination lets Pasta Protocol users move the Spaghetti workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for standard collection origination.
...
- Validated state for standard collection origination.
...
- Standalone validation: open Spaghetti, exercise standard collection origination, assert visible status and no console-modal dependency.
