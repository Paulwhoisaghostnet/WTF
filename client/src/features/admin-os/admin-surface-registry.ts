...
export const ADMIN_SURFACES: AdminSurface[] = [
  ...
  },
  {
    ...
    label: "Gamma Shell",
    domain: "Desktop OS",
    subdomain: "Gamma arcade OS shell",
    kind: "public-surface",
    routePatterns: ["/gamma"],
    adminPanelTabs: ["OS Admin", "Automation"],
    nativeSettings: [
      "presentation-host routing",
      "boot account tile",
      "session checklist launch targets",
      "command search launch targets",
      "command search keyboard shortcut",
      "focused home enter-to-continue action",
      "boot login dashboard return",
      "command result keyboard navigation",
      "command search escape dismissal",
      "keyboard return-to-desk shortcut",
      "in-shell route history controls",
      "recent route restore",
      "home session dock recovery",
      "recent app task switcher",
      "keyboard recent app switcher",
      "signed-in session console shortcuts",
      "wake queue resume order",
      "dashboard next-action rail",
      "persistent system tray shortcuts",
      "system tray shared API health state",
      "system tray notification unread state",
      "system tray clock calendar handoff",
      "app-route close-to-desk action",
      "app-route taskbar navigation",
      "app-route active focus target",
      "daily return launch targets",
      "interface switch exits",
      "locked-app recovery route",
      "auth return keyboard handoff",
      "session workspace mount table",
      "session power controls",
      "session lock control",
    ],
    automationHandles: ["public.route.viewed", "leaderboard.viewed", "app.interaction.tracked"],
    behaviorAssertionIds: [
      "gamma.login-daily-return-strip",
      "gamma.command-search-launcher",
      "gamma.command-keyboard-shortcut",
      "gamma.home-enter-continue",
      "gamma.command-result-keyboard-navigation",
      "gamma.command-escape-dismissal",
      "gamma.dashboard-next-actions",
      "gamma.app-route-keyboard-desk-shortcut",
      "gamma.route-history-recovery",
      "gamma.recent-route-restore",
      "gamma.app-task-switcher-recents",
      "gamma.session-console-shortcuts",
      "gamma.system-tray-session-status",
      "gamma.tray-notification-signals",
      "gamma.session-lock-return",
      "gamma.system-clock-calendar-handoff",
      "gamma.auth-return-continuity",
      "gamma.app-route-taskbar-navigation",
  ...
  },
  {
    ...
    adminPanelTabs: ["Safety reports", "Users", "System Logs", "Automation"],
    nativeSettings: [
      "private recipient reports",
      "operator safety disposition notes",
      "notification templates",
      "abuse review handles",
    ],
    automationHandles: [
      "dm.message.sent",
      "dm.message.reported",
    ...
    behaviorAssertionIds: [
      "messages.dm-report-review-safety-loop",
  ...
  },
  {
    ...
    label: "Contact Admin",
    domain: "Social",
    subdomain: "Direct user-to-admin feedback",
    kind: "app",
    routePatterns: ["/admin-inbox"],
    desktopAppKey: "admin-inbox",
    adminPanelTabs: ["Users", "System Logs", "Automation"],
    adminRoutes: ["/api/admin-inbox/messages", "/api/admin-inbox/threads", "/api/admin-inbox/messages/:id/replies"],
    nativeSettings: ["admin recipient roles", "evidence attachment limits", "message retention", "user reply unread state"],
    automationHandles: ["admin_inbox.message.created", "admin_inbox.message.read", "admin_inbox.reply.created", "app.interaction.tracked"],
    behaviorAssertionIds: ["admin-inbox.role-aware-feedback"],
  },
  {
    id: "comms-kernel",
    label: "Comms Kernel",
  ...
  },
  {
    ...
    behaviorAssertionIds: ["inbox.compose-reply-send-actions", "admin-inbox.role-aware-feedback", "desktop-reggie.summon-wim-messages"],
  },
  {
    id: "digest",
    label: "Digest",
  ...
  },
  {
    ...
    automationHandles: [
      ...
      "wtf_live.game_room.created",
      "wtf_live.game_room.host_app_opened",
    ...
    behaviorAssertionIds: [
      ...
      "wtf-live.game-room-jackbox-hosting",
  ...
  },
  {
    ...
    label: "Applications",
    domain: "Arcade",
    subdomain: "Remote application host",
    kind: "app",
    routePatterns: ["/applications", "/applications/:appId/play"],
    desktopAppKey: "applications",
    adminPanelTabs: ["Desktop Apps", "OS Admin", "System Logs", "Automation"],
    nativeSettings: [
      "remote apphost manifests",
      "single active external application",
      "browser WebRTC session lifecycle",
      "remote desktop input forwarding",
      "Steam-backed app launch privacy",
  ...
  },
  {
    ...
    label: "Profile",
    domain: "Social",
    subdomain: "Account identity and wallet linking",
    kind: "app",
    routePatterns: ["/profile"],
    adminPanelTabs: ["Users", "WTF Tez", "Automation", "System Logs"],
    nativeSettings: ["account identity", "wallet linking", "wallet provider lifecycle", "social verification"],
    automationHandles: ["user.wallet.connected", "profile.updated", "app.interaction.tracked"],
    behaviorAssertionIds: [
  ...
  },
  {
    ...
    kind: "app",
    routePatterns: ["/marketplace", "/trade-boards", "/swap", "/collekt", "/tezos-intel"],
    adminPanelTabs: ["Contract Ledger", "Rewards", "Automation"],
  ...
  },
  {
    ...
    automationHandles: [
      ...
      "pasta_protocol.contract_recorded",
      "pasta_protocol.contract_verified",
      "pasta_protocol.contract_resumed",
      "pasta_protocol.contract_forgotten",
    ...
    behaviorAssertionIds: [
      ...
      "pasta-protocol.self-hosted-site-exports",
      "pasta-protocol.colander-project-workspace",
  ...
  },
  {
    ...
    nativeSettings: [
      ...
      "separate permanent user deletion permission",
      "sortable role and assigned-user review",
      "curse catalog and assignment scope",
      "exhaustive human and agent help index",
      "desktop app registration refresh and permanent credentials",
      "surface registry",
      "permissions",
      "user curses",
      "reward automation",
    ...
    behaviorAssertionIds: [
      ...
      "admin.user-deletion-least-privilege",
  ...
  },
  {
    ...
    kind: "admin-tool",
    routePatterns: ["/objkt-operator"],
    adminPanelTabs: ["Contract Ledger", "Automation", "System Logs"],
    adminRoutes: ["/api/objkt-operator/*"],
    nativeSettings: [
      "owner account allowlist",
      "creator review decisions",
      "buy policy and spend cap",
      "market scans and signing queue",
      "durable operator event history",
    ],
    automationHandles: [
  ...
  },
  {
    id: "payroll",
    label: "Payroll",
    desktopAppKey: "payroll",
    domain: "Admin",
    subdomain: "Treasury funding",
    kind: "admin-tool",
    routePatterns: ["/payroll"],
    adminPanelTabs: ["Contract Ledger", "Rewards", "Automation"],
    adminRoutes: ["/payroll"],
    nativeSettings: [
      "isolated funding wallet connection",
      "mainnet chain and account preflight",
      "WTF and XTZ transfer review",
      "confirmed operation handoff",
    ],
    automationHandles: [
    ...
    behaviorAssertionIds: ["payroll.isolated-wallet-and-value-transfer"],
  },
  {
    id: "ux-lab",
    label: "UX Lab",
...
export const DESKTOP_ITEM_ADMIN_SURFACES: AdminSurface[] = [
  ...
  },
  {
    ...
    nativeSettings: [
      ...
      "desktop context-menu summon",
      "WIM-backed assistant messages",
    ],
    automationHandles: [
    ...
    behaviorAssertionIds: ["desktop-reggie.summon-wim-messages"],
  },
  {
    id: "desktop-icons",
    label: "Desktop Icons",
