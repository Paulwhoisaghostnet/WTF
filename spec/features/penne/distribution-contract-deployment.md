# Penne: Distribution contract deployment

## Purpose

Distribution contract deployment lets Pasta Protocol users move the Penne workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for distribution contract deployment.
...
- Validated state for distribution contract deployment.
...
- Standalone validation: open Penne, exercise distribution contract deployment, assert visible status and no console-modal dependency.
