# Puppet Collections: Puppet mint

## Purpose

Prove that puppet mint supports Pasta Protocol creator, collector, and operator workflows without hiding deployment, hosting, or availability state.
...
- Validation evidence and recovery status for puppet mint.
