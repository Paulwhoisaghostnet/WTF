# Colander: Wallet and network context

## Purpose

Wallet and network context lets Pasta Protocol users move the Colander workflow toward a valid management outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for wallet and network context.
...
- Validated state for wallet and network context.
...
- Standalone validation: open Colander, exercise wallet and network context, assert visible status and no console-modal dependency.
