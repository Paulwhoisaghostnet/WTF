export const DOMAIN_WORKFLOWS = [
  ...
  },
  {
    ...
    apiProbes: [
      { method: "GET", path: "/api/music/tracks", expectedStatuses: [200, 401, 404] },
      { method: "GET", path: "/api/mastodon/account", expectedStatuses: [200, 401] },
      { method: "GET", path: "/api/mastodon/timeline", expectedStatuses: [200, 401] },
      { method: "GET", path: "/api/porcupin/status", expectedStatuses: [200, 401, 404] },
      { method: "GET", path: "/api/discovery/random-artist", expectedStatuses: [200, 401, 404] },
      { method: "GET", path: "/api/discovery/random-nft", expectedStatuses: [200, 401, 404] },
      { method: "GET", path: "/api/discovery/spotlight", expectedStatuses: [200, 401, 404] },
      { method: "GET", path: "/api/social-automation/promoter/status", expectedStatuses: [200, 401, 403, 404] },
      { method: "GET", path: "/api/social-automation/weekly", expectedStatuses: [200, 401, 403, 404] },
      { method: "GET", path: "/api/factory/templates" },
    ],
  },
];
