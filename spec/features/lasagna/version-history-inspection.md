# Lasagna: Version history inspection

## Purpose

Version history inspection lets Pasta Protocol users move the Lasagna workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for version history inspection.
...
- Validated state for version history inspection.
...
- Standalone validation: open Lasagna, exercise version history inspection, assert visible status and no console-modal dependency.
