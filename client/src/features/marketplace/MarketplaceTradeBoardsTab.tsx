...
import {
  ...
  ListingTitleBar,
  TokenImage,
  TradeBoardBarterSurface,
  TradeBoardEmptyState,
  TradeBoardGridWrap,
  TradeBoardLoadingState,
  TradeBoardModeButton,
  TradeBoardSearchWrap,
  TradeBoardSurface,
  TradeBoardToolbar,
...
export function MarketplaceTradeBoardsTab({
  ...
  return (
    <TradeBoardSurface>
      <TradeBoardToolbar>
        <TradeBoardModeButton data-marketplace-mode-active={mode === "offers"}>
          <Button active={mode === "offers"} onClick={() => onModeChange("offers")}>
            Offer Board
          </Button>
        </TradeBoardModeButton>
        <TradeBoardModeButton data-marketplace-mode-active={mode === "barter"}>
      ...
      {mode === "barter" ? (
        ...
        <TradeBoardGridWrap>
          <Grid>
            ...
            {items.length === 0 && (
              <TradeBoardEmptyState>No trade board tokens found.</TradeBoardEmptyState>
            )}
          </Grid>
        </TradeBoardGridWrap>
      )}
