# Gnocchi: Open-edition contract deployment

## Purpose

Open-edition contract deployment lets Pasta Protocol users move the Gnocchi workflow toward a valid token product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for open-edition contract deployment.
...
- Validated state for open-edition contract deployment.
...
- Standalone validation: open Gnocchi, exercise open-edition contract deployment, assert visible status and no console-modal dependency.
