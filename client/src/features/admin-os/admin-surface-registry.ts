...
export const ADMIN_SURFACES: AdminSurface[] = [
  ...
  },
  {
    ...
    desktopAppKey: "mail",
    adminPanelTabs: ["Users", "System Logs", "Automation"],
    nativeSettings: ["staff-alpha rollout", "mailbox provisioning", "Resend domain status", "delivery failures", "unread badge", "read-state sync", "message marks", "new message composer", "inline WIM/Studio replies", "saved drafts/templates"],
    automationHandles: [
      "inbox.viewed",
      "inbox.message.read",
