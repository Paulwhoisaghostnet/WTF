# Colander: Pasta adapter detection

## Purpose

Pasta adapter detection lets Pasta Protocol users move the Colander workflow toward a valid management outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for pasta adapter detection.
...
- Validated state for pasta adapter detection.
...
- Standalone validation: open Colander, exercise pasta adapter detection, assert visible status and no console-modal dependency.
