...
export const FALLBACK_DEMO_CARTRIDGES: ConsoleCartridge[] = [
  ...
  {
    id: "demo-inverse-snake",
    slug: "inverse-snake",
    title: "Inverse Snake",
    description: "A backwards snack chase where the apple hunts the snake.",
    mimeType: "text/html",
    thumbnailUri: null,
    artifactUri: "/games/wtf/inverse-snake/index.html",
    tokenContract: "demo",
    tokenId: "inverse-snake",
    isDemo: true,
    kind: "html5",
    category: "arcade",
    leaderboardEnabled: false,
