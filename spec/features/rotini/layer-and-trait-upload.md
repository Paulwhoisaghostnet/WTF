# Rotini: Layer and trait upload

## Purpose

Layer and trait upload lets Pasta Protocol users move the Rotini workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for layer and trait upload.
...
- Validated state for layer and trait upload.
...
- Standalone validation: open Rotini, exercise layer and trait upload, assert visible status and no console-modal dependency.
