# Rotini: Rarity and uniqueness configuration

## Purpose

Rarity and uniqueness configuration lets Pasta Protocol users move the Rotini workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for rarity and uniqueness configuration.
...
- Validated state for rarity and uniqueness configuration.
...
- Standalone validation: open Rotini, exercise rarity and uniqueness configuration, assert visible status and no console-modal dependency.
