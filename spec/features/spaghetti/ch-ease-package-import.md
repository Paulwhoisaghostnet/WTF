...
CH-EASE package import lets Pasta Protocol users move the Spaghetti workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for ch-ease package import.
...
- Validated state for ch-ease package import.
...
- Standalone validation: open Spaghetti, exercise ch-ease package import, assert visible status and no console-modal dependency.
