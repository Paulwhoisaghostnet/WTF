# Colander: Role/admin update forms

## Purpose

Role/admin update forms lets Pasta Protocol users move the Colander workflow toward a valid management outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for role/admin update forms.
...
- Validated state for role/admin update forms.
...
- Standalone validation: open Colander, exercise role/admin update forms, assert visible status and no console-modal dependency.
