...
const INSTALLER_PLATFORMS = [
  {
    key: "macos",
    label: "macOS",
    env: "GNOCCHI_INSTALLER_MACOS_URL",
    sha256Env: "GNOCCHI_INSTALLER_MACOS_SHA256",
    fileName: "Gnocchi-Studio.dmg",
  },
  {
    key: "windows",
    label: "Windows",
    env: "GNOCCHI_INSTALLER_WINDOWS_URL",
    sha256Env: "GNOCCHI_INSTALLER_WINDOWS_SHA256",
    fileName: "Gnocchi-Studio.exe",
  },
  {
    key: "raspberry-pi",
    label: "Raspberry Pi",
    env: "GNOCCHI_INSTALLER_RASPBERRY_PI_URL",
    sha256Env: "GNOCCHI_INSTALLER_RASPBERRY_PI_SHA256",
    fileName: "gnocchi-studio-arm64.deb",
  },
] as const;
...
router.get("/api/gnocchi/installers", isAuthenticated, (_req, res) => {
  const version = String(process.env.GNOCCHI_INSTALLER_VERSION || "").trim();
  return res.json({
    ok: true,
    product: "gnocchi",
