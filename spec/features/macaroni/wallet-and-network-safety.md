# Macaroni: Wallet and network safety

## Purpose

Wallet and network safety lets Pasta Protocol users move the Macaroni workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for wallet and network safety.
...
- Validated state for wallet and network safety.
...
- Standalone validation: open Macaroni, exercise wallet and network safety, assert visible status and no console-modal dependency.
