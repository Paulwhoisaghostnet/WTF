export const DOMAIN_WORKFLOWS = [
  ...
  },
  {
    ...
    routes: ["/messageboard", "/w", "/skywire", "/tz2at", "/crp-nominate", "/messages", "/mail", "/digest", "/wim", "/browser", "/dear-diary", "/dicksword", "/i-hate-telegram", "/admin"],
    eventHandles: [
    ...
    apiProbes: [
      ...
      { method: "POST", path: "/api/skywire/chats/test-convo/messages", body: { text: "e2e chat reply" }, expectedStatuses: [201, 400, 401, 403, 409] },
      { method: "POST", path: "/api/skywire/chats/send", body: { members: ["did:plc:testmember"], text: "e2e chat message" }, expectedStatuses: [201, 400, 401, 403, 409] },
      { method: "GET", path: "/api/skywire/rooms" },
      { method: "GET", path: "/api/skywire/rooms/wtf-live/messages" },
      { method: "POST", path: "/api/skywire/rooms/wtf-live/messages", body: { text: "e2e room message" }, expectedStatuses: [201, 400, 401, 403, 409] },
      { method: "GET", path: "/api/skywire/stages" },
      { method: "GET", path: "/api/skywire/stages/wtf-stage/broadcasts" },
      { method: "POST", path: "/api/skywire/stages/wtf-stage/broadcasts", body: { text: "e2e stage broadcast", mode: "text" }, expectedStatuses: [201, 400, 401, 403, 409] },
