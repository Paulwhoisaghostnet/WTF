...
export const GUINEA_PIG_RACEWAY_GAME_STUB: CasinoGameStub = {
  ...
  summary:
    "A planned live 3D Casino raceway where players use entertainment-only WTF tickets on statted racers, watch the race unfold, buy capped mid-race effects, and review audit-backed multi-angle replays while the next book opens.",
  mode: "multi_player",
  ...
  highlights: [
    ...
    "Win, Place, Show, Exacta, and Trifecta tote pools",
  ...
  rules: {
    ...
    entertainmentOnly: GUINEA_PIG_RACEWAY_RULES.entertainmentOnly,
    tokenValueStatement: GUINEA_PIG_RACEWAY_RULES.tokenValueStatement,
    ...
    breakageUnitMicrowtf: GUINEA_PIG_RACEWAY_RULES.breakageUnitMicrowtf,
