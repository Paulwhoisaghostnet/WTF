# CH-EASE: Package creation and source load

## Purpose

Package creation and source load lets Pasta Protocol users move the CH-EASE workflow toward a valid package outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for package creation and source load.
...
- Validated state for package creation and source load.
...
- Standalone validation: open CH-EASE, exercise package creation and source load, assert visible status and no console-modal dependency.
