# Ravioli: Colander bundle handoff

## Purpose

Colander bundle handoff lets Pasta Protocol users move the Ravioli workflow toward a valid token product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for colander bundle handoff.
...
- Validated state for colander bundle handoff.
...
- Standalone validation: open Ravioli, exercise colander bundle handoff, assert visible status and no console-modal dependency.
