# Lasagna: Hosted exhibition export

## Purpose

Hosted exhibition export lets Pasta Protocol users move the Lasagna workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for hosted exhibition export.
...
- Validated state for hosted exhibition export.
...
- Standalone validation: open Lasagna, exercise hosted exhibition export, assert visible status and no console-modal dependency.
