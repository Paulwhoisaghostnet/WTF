# Spaghetti: Private management dashboard export

## Purpose

Private management dashboard export lets Pasta Protocol users move the Spaghetti workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for private management dashboard export.
...
- Validated state for private management dashboard export.
...
- Standalone validation: open Spaghetti, exercise private management dashboard export, assert visible status and no console-modal dependency.
