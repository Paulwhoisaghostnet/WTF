# Lasagna: Colander curation handoff

## Purpose

Colander curation handoff lets Pasta Protocol users move the Lasagna workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for colander curation handoff.
...
- Validated state for colander curation handoff.
...
- Standalone validation: open Lasagna, exercise colander curation handoff, assert visible status and no console-modal dependency.
