# Colander: External publisher handoff

## Purpose

External publisher handoff lets Pasta Protocol users move the Colander workflow toward a valid management outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for external publisher handoff.
...
- Validated state for external publisher handoff.
...
- Standalone validation: open Colander, exercise external publisher handoff, assert visible status and no console-modal dependency.
