# Macaroni: Reveal and owned-mint recovery

## Purpose

Reveal and owned-mint recovery lets Pasta Protocol users move the Macaroni workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for reveal and owned-mint recovery.
...
- Validated state for reveal and owned-mint recovery.
...
- Standalone validation: open Macaroni, exercise reveal and owned-mint recovery, assert visible status and no console-modal dependency.
