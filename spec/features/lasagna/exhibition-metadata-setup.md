# Lasagna: Exhibition metadata setup

## Purpose

Exhibition metadata setup lets Pasta Protocol users move the Lasagna workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for exhibition metadata setup.
...
- Validated state for exhibition metadata setup.
...
- Standalone validation: open Lasagna, exercise exhibition metadata setup, assert visible status and no console-modal dependency.
