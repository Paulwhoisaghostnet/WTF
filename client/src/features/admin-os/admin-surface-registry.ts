...
export const ADMIN_SURFACES: AdminSurface[] = [
  ...
  },
  {
    ...
    automationHandles: ["aim.chat.opened", "aim.message.sent", "dm.message.sent", "app.interaction.tracked"],
  },
  {
    id: "browser",
    label: "Browser",
  ...
  },
  {
    ...
    kind: "tool",
    routePatterns: ["/api/mastodon/account", "/api/mastodon/timeline"],
  ...
  },
  {
    ...
    kind: "tool",
    routePatterns: ["/api/discovery/random-artist", "/api/discovery/random-nft", "/api/discovery/spotlight"],
  ...
  },
  {
    ...
    kind: "tool",
    routePatterns: ["/api/social-automation/promoter/status", "/api/social-automation/weekly"],
