# Macaroni: Generated mint page hosting/export

## Purpose

Generated mint page hosting/export lets Pasta Protocol users move the Macaroni workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for generated mint page hosting/export.
...
- Validated state for generated mint page hosting/export.
...
- Standalone validation: open Macaroni, exercise generated mint page hosting/export, assert visible status and no console-modal dependency.
