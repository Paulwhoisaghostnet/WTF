# Macaroni: Collector mint and quantity preflight

## Purpose

Collector mint and quantity preflight lets Pasta Protocol users move the Macaroni workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for collector mint and quantity preflight.
...
- Validated state for collector mint and quantity preflight.
...
- Standalone validation: open Macaroni, exercise collector mint and quantity preflight, assert visible status and no console-modal dependency.
