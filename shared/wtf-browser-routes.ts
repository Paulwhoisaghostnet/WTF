...
export const BROWSER_ROUTE_META: readonly BrowserRouteMeta[] = [
  ...
  { pattern: "/tools/colander", auth: true, roles: ["admin", "host", "cohost", "trusted_creator"], title: "Colander" },
  ...
  { pattern: "/tools/spaghetti", auth: true, roles: ["admin", "host", "cohost", "trusted_creator"], title: "Spaghetti" },
  { pattern: "/tools/gnocchi", auth: true, roles: ["admin", "host", "cohost", "trusted_creator"], title: "Gnocchi" },
  { pattern: "/tools/ravioli", auth: true, roles: ["admin", "host", "cohost", "trusted_creator"], title: "Ravioli" },
  { pattern: "/tools/rotini", auth: true, roles: ["admin", "host", "cohost", "trusted_creator"], title: "Rotini" },
  { pattern: "/tools/penne", auth: true, roles: ["admin", "host", "cohost", "trusted_creator"], title: "Penne" },
  { pattern: "/tools/lasagna", auth: true, roles: ["admin", "host", "cohost", "trusted_creator"], title: "Lasagna" },
