# Penne: Allocation recovery/export

## Purpose

Allocation recovery/export lets Pasta Protocol users move the Penne workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for allocation recovery/export.
...
- Validated state for allocation recovery/export.
...
- Standalone validation: open Penne, exercise allocation recovery/export, assert visible status and no console-modal dependency.
