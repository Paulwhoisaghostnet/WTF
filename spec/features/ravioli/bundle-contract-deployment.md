# Ravioli: Bundle contract deployment

## Purpose

Bundle contract deployment lets Pasta Protocol users move the Ravioli workflow toward a valid token product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for bundle contract deployment.
...
- Validated state for bundle contract deployment.
...
- Standalone validation: open Ravioli, exercise bundle contract deployment, assert visible status and no console-modal dependency.
