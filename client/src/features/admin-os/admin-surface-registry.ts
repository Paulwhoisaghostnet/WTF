...
export const ADMIN_SURFACES: AdminSurface[] = [
  ...
  },
  {
    ...
    automationHandles: ["dm.message.sent", "notification.viewed", "reggie.message.sent", "app.interaction.tracked"],
    behaviorAssertionIds: ["inbox.compose-reply-send-actions", "desktop-reggie.summon-wim-messages"],
  },
  {
    id: "admin-inbox",
    label: "Contact Admin",
