# Gnocchi: Open-edition metadata setup

## Purpose

Open-edition metadata setup lets Pasta Protocol users move the Gnocchi workflow toward a valid token product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for open-edition metadata setup.
...
- Validated state for open-edition metadata setup.
...
- Standalone validation: open Gnocchi, exercise open-edition metadata setup, assert visible status and no console-modal dependency.
