...
6. Publish and configure the Gnocchi, Ravioli, Rotini, Penne, and Lasagna standalone release assets, then make each live installer verifier pass. Decide whether Colander should ship as a separate native admin app or remain an in-suite/main-app surface.
