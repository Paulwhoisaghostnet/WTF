# WTFOS Pinning: Artifact pinning

## Purpose

Prove that artifact pinning supports Pasta Protocol creator, collector, and operator workflows without hiding deployment, hosting, or availability state.
...
- Validation evidence and recovery status for artifact pinning.
