# Rotini: Regeneration from seed

## Purpose

Regeneration from seed lets Pasta Protocol users move the Rotini workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for regeneration from seed.
...
- Validated state for regeneration from seed.
...
- Standalone validation: open Rotini, exercise regeneration from seed, assert visible status and no console-modal dependency.
