...
export const BETA_PERSISTENT_AGENTS: BetaPersistentAgent[] = [
  ...
  },
  {
    ...
    successCondition: "Moves from Gallery to Dashboard, Rat Race, WTFIAM, or Marketplace without help.",
...
export const BETA_AGENT_RUNS: BetaAgentRun[] = [
  ...
  },
  {
    ...
    performedTask: true,
    discoveredNextStep: true,
    confusion: "Marketplace, Rat Race, Dashboard, and WTFIAM still overlap semantically.",
...
export const BETA_VISIBILITY_SIGNALS: BetaVisibilitySignal[] = [
  ...
  { key: "collectors", label: "Collectors", status: "direct", route: "/gallery", evidence: "Collector path connects Gallery, Dashboard, Rat Race, WTFIAM, and Marketplace.", nextImprovement: "Show collector movement from public leaderboard and market signals." },
  ...
  { key: "new-collections", label: "New collections", status: "routed", route: "/gallery", evidence: "Gallery and Dashboard are grouped into collection discovery.", nextImprovement: "Distinguish collection, token, and owner movement in the atlas." },
  ...
  { key: "interesting-wallets", label: "Interesting wallets", status: "routed", route: "/dashboard", evidence: "Dashboard, Tezos Intel, tz2at, and Leaderboard are mapped as wallet intelligence.", nextImprovement: "Explain safe wallet discovery before any wallet action." },
...
export const BETA_ROUTE_BRIDGES: BetaRouteBridge[] = [
  ...
  { from: "I found art", to: "Dashboard / Rat Race", route: "/rat-race", reason: "Connect discovery to ownership, wallet context, market motion, and collection identity." },
