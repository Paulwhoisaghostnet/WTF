# Gnocchi: Collection/artifact pinning

## Purpose

Collection/artifact pinning lets Pasta Protocol users move the Gnocchi workflow toward a valid token product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for collection/artifact pinning.
...
- Validated state for collection/artifact pinning.
...
- Standalone validation: open Gnocchi, exercise collection/artifact pinning, assert visible status and no console-modal dependency.
