# Puppet Collections: Puppet collector discovery

## Purpose

Prove that puppet collector discovery supports Pasta Protocol creator, collector, and operator workflows without hiding deployment, hosting, or availability state.
...
- Validation evidence and recovery status for puppet collector discovery.
