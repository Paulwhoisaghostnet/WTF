...
export const BETA_PEOPLE_DISCOVERY_BOARD: BetaPeopleDiscoveryCard[] = [
  ...
  },
  {
    ...
    nextAction: "Open Gallery first, then Dashboard, Rat Race, Marketplace, or WTFIAM when the user wants deeper collection context.",
  ...
  },
  {
    ...
    nextAction: "Open Leaderboards first, then Gallery, Dashboard, tz2at, or Profile when the user wants more context.",
    quietFallback: "If wallet proof is quiet, keep public object discovery first and avoid pushing contract-heavy actions.",
    relatedRoutes: ["/gallery", "/dashboard", "/tz2at", "/profile"],
  },
];
...
export const BETA_PEOPLE_PROOF_GAPS: BetaPeopleProofGap[] = [
  ...
  },
  {
    ...
    nextBetaMove: "Keep Gallery as the safe inspection route, then route to Dashboard, Rat Race, Marketplace, and WTFIAM only when context is needed.",
  ...
  },
  {
    ...
    currentWeakness: "Wallet context can still feel advanced when the user does not know whether to open Leaderboards, Gallery, Dashboard, tz2at, or Profile next.",
