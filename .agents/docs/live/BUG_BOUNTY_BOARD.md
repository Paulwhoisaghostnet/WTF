...
- Evidence:
  ...
  - The current host-gate audit pass removes the stale default live-check host and requires `PASTA_WTFME_LIVE_HOST` to be the exact host emitted by the publish script.
