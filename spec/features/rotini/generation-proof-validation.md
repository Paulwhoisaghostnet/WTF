# Rotini: Generation proof validation

## Purpose

Generation proof validation lets Pasta Protocol users move the Rotini workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for generation proof validation.
...
- Validated state for generation proof validation.
...
- Standalone validation: open Rotini, exercise generation proof validation, assert visible status and no console-modal dependency.
