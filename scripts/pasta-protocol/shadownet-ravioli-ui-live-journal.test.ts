...
test("an exact disposable event-86 journal copy appends event 87, completes the 67-operation effective plan, and rejects extension, op67, or sealed-evidence loss and drift", async () => {
