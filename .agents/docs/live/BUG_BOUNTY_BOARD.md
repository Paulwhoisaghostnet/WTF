...
| WTF-BB-342 | In Progress | Codex Pasta primary scratch/live host audit | 2026-07-02 | Pasta Protocol / WTF.ME host and pin recovery | P1 | 13 | 6 | 2 | 5 | 2 | Pasta WTF.ME hosted-page and source-level pinning/recovery proofs exist locally, and current live `c723382` verifies repo cleanup, installer assets/catalog, static runtime markers, signer-backed Colander action proof `oo2qtySsskwgYE41BAvN2jxYpvi1L8zugNwyk1JHXUWbYCj8P3h`, non-spending TzKT replay, and strict `pasta:live-readiness:final`; final launch remains blocked only on missing dedicated WTF.ME publish credentials plus no public Pasta WTF.ME host, with `paulwhoisaghost.wtfos.me` TLS-allowed but missing Pasta landing markers and `wtf-admin.wtfos.me` still unregistered |
