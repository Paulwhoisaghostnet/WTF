# Lasagna: Publish revision

## Purpose

Publish revision lets Pasta Protocol users move the Lasagna workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for publish revision.
...
- Validated state for publish revision.
...
- Standalone validation: open Lasagna, exercise publish revision, assert visible status and no console-modal dependency.
