export const ROUTE_FIXTURES = [
  ...
  { pattern: "/aim", path: "/aim", title: "AIM", domain: "social", subdomain: "Instant messenger", auth: true },
  ...
  { pattern: "/creation-tools/pixel-patterns", path: "/creation-tools/pixel-patterns", title: "PixelPatterns", domain: "media", subdomain: "Creation tools", auth: true },
  { pattern: "/creation-tools/backgrounds", path: "/creation-tools/backgrounds", title: "PenRose Backgrounds", domain: "media", subdomain: "Creation tools", auth: true },
  ...
  { pattern: "/api/mastodon/account", path: "/api/mastodon/account", title: "Mastodon Account API", domain: "social", subdomain: "Mastodon", auth: true },
  { pattern: "/api/mastodon/timeline", path: "/api/mastodon/timeline", title: "Mastodon Timeline API", domain: "social", subdomain: "Mastodon", auth: true },
  { pattern: "/api/discovery/random-artist", path: "/api/discovery/random-artist", title: "Random Artist API", domain: "commerce", subdomain: "Discovery engine", auth: true },
  { pattern: "/api/discovery/random-nft", path: "/api/discovery/random-nft", title: "Random NFT API", domain: "commerce", subdomain: "Discovery engine", auth: true },
  { pattern: "/api/discovery/spotlight", path: "/api/discovery/spotlight", title: "Discovery Spotlight API", domain: "commerce", subdomain: "Discovery engine", auth: true },
  { pattern: "/api/social-automation/promoter/status", path: "/api/social-automation/promoter/status", title: "Social Automation Status API", domain: "social", subdomain: "Social automation", auth: true },
  { pattern: "/api/social-automation/weekly", path: "/api/social-automation/weekly", title: "Social Automation Weekly API", domain: "social", subdomain: "Social automation", auth: true },
];
