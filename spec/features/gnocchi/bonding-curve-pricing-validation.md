# Gnocchi: Bonding-curve pricing validation

## Purpose

Bonding-curve pricing validation lets Pasta Protocol users move the Gnocchi workflow toward a valid token product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for bonding-curve pricing validation.
...
- Validated state for bonding-curve pricing validation.
...
- Standalone validation: open Gnocchi, exercise bonding-curve pricing validation, assert visible status and no console-modal dependency.
