...
assert.match(
  caddyfile,
  /wtfos\.app,\s*skywire\.wtfos\.app,\s*dues\.wtfgameshow\.app\s*\{/,
  "Caddyfile must serve the canonical wtfos.app host and Skywire product subdomain without the legacy wtfgameshow platform aliases",
);
