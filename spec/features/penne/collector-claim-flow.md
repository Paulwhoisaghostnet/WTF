# Penne: Collector claim flow

## Purpose

Collector claim flow lets Pasta Protocol users move the Penne workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for collector claim flow.
...
- Validated state for collector claim flow.
...
- Standalone validation: open Penne, exercise collector claim flow, assert visible status and no console-modal dependency.
