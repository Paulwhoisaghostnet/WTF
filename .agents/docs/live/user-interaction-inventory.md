...
| WTF Casino now has app access and membership-card scaffolding, but wagered games remain intentionally fail-closed. | Do not mark Casino wagering live until compliance gates, wallet-backed wager settlement, house accounting, anti-replay controls, and game-specific behavior tests exist. | `WTF-BB-138` |
