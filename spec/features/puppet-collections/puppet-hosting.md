# Puppet Collections: Puppet hosting

## Purpose

Prove that puppet hosting supports Pasta Protocol creator, collector, and operator workflows without hiding deployment, hosting, or availability state.
...
- Validation evidence and recovery status for puppet hosting.
