...
export const triggerRegistry: TriggerDefinition[] = [
  ...
  {
    key: "blockchain.tezos.activity",
    label: "Tezos wallet activity",
    description: "Fires when the WTFOS wallet surveillance pipeline normalizes linked-wallet Tezos activity into the SystemEvent spine.",
    ...
    eventTypes: [
      ...
      "blockchain.tezos.token_burn",
      "blockchain.tezos.xtz_transfer_in",
      "blockchain.tezos.xtz_transfer_out",
      "blockchain.tezos.contract_call",
      "blockchain.tezos.delegation",
      "blockchain.tezos.origination",
    ],
    comparisonModes: ["exists", "not_exists", "count_gte", "count_eq", "count_lte"],
    timingMode: "counted",
  },
