# Colander: Available action filtering

## Purpose

Available action filtering lets Pasta Protocol users move the Colander workflow toward a valid management outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for available action filtering.
...
- Validated state for available action filtering.
...
- Standalone validation: open Colander, exercise available action filtering, assert visible status and no console-modal dependency.
