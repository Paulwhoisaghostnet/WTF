# Penne: Failure replay controls

## Purpose

Failure replay controls lets Pasta Protocol users move the Penne workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for failure replay controls.
...
- Validated state for failure replay controls.
...
- Standalone validation: open Penne, exercise failure replay controls, assert visible status and no console-modal dependency.
