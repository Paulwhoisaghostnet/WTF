# WTFOS Pinning: Metadata pinning

## Purpose

Prove that metadata pinning supports Pasta Protocol creator, collector, and operator workflows without hiding deployment, hosting, or availability state.
...
- Validation evidence and recovery status for metadata pinning.
