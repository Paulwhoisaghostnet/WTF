# Macaroni: Share, calendar, and static bundle export

## Purpose

Share, calendar, and static bundle export lets Pasta Protocol users move the Macaroni workflow toward a valid contract product outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for share, calendar, and static bundle export.
...
- Validated state for share, calendar, and static bundle export.
...
- Standalone validation: open Macaroni, exercise share, calendar, and static bundle export, assert visible status and no console-modal dependency.
