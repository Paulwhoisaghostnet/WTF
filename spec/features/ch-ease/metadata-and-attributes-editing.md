# CH-EASE: Metadata and attributes editing

## Purpose

Metadata and attributes editing lets Pasta Protocol users move the CH-EASE workflow toward a valid package outcome while preserving wallet, pinning, relationship metadata, and recovery guarantees.
...
- User-entered configuration for metadata and attributes editing.
...
- Validated state for metadata and attributes editing.
...
- Standalone validation: open CH-EASE, exercise metadata and attributes editing, assert visible status and no console-modal dependency.
